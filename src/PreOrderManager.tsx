    ...
    <div className="fixed inset-0 z-[100] bg-[#070b14] text-[#e2e8f0] flex flex-col font-sans overflow-hidden md:left-[240px]">
      ...
      >
        ...
        <div className="bg-[#0b1120] border border-[#1e293b]/70 rounded-2xl p-4 md:p-6 shadow-xl space-y-4">
          <div className="flex items-center justify-between pb-4 border-b border-[#1e293b]/50">
            <div className="flex items-center gap-3">
            ...
            <button
              ...
              className={cn(
                ...
                enabled ? "bg-emerald-500 shadow-md shadow-emerald-500/20" : "bg-slate-700/60"
              )}
            >
              <div
                className={cn(
          ...
          {enabled && (
            <div className="space-y-2 pt-2 animate-in fade-in slide-in-from-top-2 duration-200">
              <label className="text-xs font-semibold text-slate-300 tracking-wide flex items-center gap-1.5">
                <Link2 size={13} className="text-blue-400" /> Destination URL <span className="text-pink-400">*</span>
              </label>
              <input 
                type="url"
                value={link}
                ...
                className="w-full bg-[#070b14] border border-[#1e293b] rounded-xl px-4 py-3 text-sm text-white focus:outline-none focus:border-pink-500 focus:ring-1 focus:ring-pink-500/50 transition-all placeholder:text-slate-600 font-mono"
              />
        ...
        <div className="bg-[#0b1120] border border-[#1e293b]/70 rounded-2xl p-4 md:p-6 shadow-xl space-y-4">
          ...
          <div className="space-y-3 pt-1">
            {dashboards.length === 0 ? (
              <div className="text-center py-8 px-4 rounded-xl border border-dashed border-[#1e293b] bg-white/[0.01]">
              ...
              dashboards.map((dash, i) => (
                <div 
                  key={dash.id || i} 
                  className="bg-[#070b14] border border-[#1e293b] p-3.5 rounded-xl space-y-3 transition-all hover:border-slate-700 group"
                >
                  <div className="flex items-center justify-between">
                    <span className="text-xs font-bold text-purple-400 flex items-center gap-1.5">
                      <span className="w-2 h-2 rounded-full bg-purple-400" /> Workspace #{i + 1}
                    </span>
                    <button 
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full bg-[#0b1120] border border-[#1e293b] rounded-lg px-3 py-2 text-xs text-white focus:outline-none focus:border-purple-500 transition-colors placeholder:text-slate-600"
                      />
                    </div>
                    <div>
                      ...
                      <input
                        ...
                        className="w-full bg-[#0b1120] border border-[#1e293b] rounded-lg px-3 py-2 text-xs text-white focus:outline-none focus:border-purple-500 transition-colors font-mono placeholder:text-slate-600"
                      />
                    </div>
                  </div>
                </div>
            ...
            <button
              ...
              className="w-full py-3 rounded-xl border border-dashed border-[#1e293b] hover:border-purple-500/50 bg-white/[0.01] hover:bg-purple-500/[0.04] text-slate-400 hover:text-purple-300 flex items-center justify-center gap-2 transition-all text-xs font-semibold cursor-pointer"
            >
